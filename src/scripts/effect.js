...
$('document').ready(function(){
	...
	$('#invite_friends').click(function(){
		...
		$('#b6').attr('id','b66')
		$('#b7').attr('id','b77')
		$('#b11').animate({top:240, left: 100},500);
		$('#b22').animate({top:240, left: 100 + vw/4},500);
		$('#b88').animate({top:240, left: 100 + vw/2},500);
		$('#b33').animate({top:240, left: 100 + vw*3/4},500);
		$('#b44').animate({top:240, left: 100 + vw},500);
		$('#b55').animate({top:240, left: 100 + vw*5/4},500);
		$('#b66').animate({top:240, left: 100 + vw*3/2},500);
		$('#b77').animate({top:240, left: 100 + vw*7/4},500);
